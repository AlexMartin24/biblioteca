        ...
        cursos: [
            {
                ...
                idProfesor: 1, // Referencia al ID del profesor
                inscripciones: [],
            },
        ],
    },
...
ObtenerProfesorPorId(idProfesor: number): Profesor | undefined {
  return this.listaProfesores.find(profesor => profesor.idProfesor === idProfesor);
}
